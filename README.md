...
|---|--|----------------------------------------------------------------------------------------------------------------|--------------------------------------------|-          |-              |-      |-      |-      |-                     |-          |-             | -  |--------------------------------------------|
|:-1:|1 | [EDP Open Data](https://www.edp.com/en/innovation/open-data/data)                                              | [here](notebooks/edp_open_data.ipynb)      | ESP (on)  |&check;        | 5     |~80    | &check;     | &check;<sup>[1](#fn1)</sup>| 10m     | 2y |  - | :warning: Currently unavailable; T09 removed from dataset |
...
|:star:|3 | [Kelmarsh Farm](https://zenodo.org/record/5841834#.YgpBQ_so-V7)                                                | [here](notebooks/kelmarsh_open_data.ipynb) | UK (on)   |&cross;        | 6     |~99     | &check;     | &cross;                    | 10m<sup>[3](#fn3)</sup>     | 5y|  - | [farm info](https://www.thewindpower.net/windfarm_en_17507_kelmarsh.php)|
|:star:|4 | [Penmanshiel Farm](https://zenodo.org/record/5946808#.YgpAmvso-V5)                                             | &cross;                                    | UK (on)   |&cross;        |14     |>150     | &check;     | &cross;                   | 10m<sup>[3](#fn3)</sup>     | 5y|  - | [farm info](https://www.thewindpower.net/windfarm_en_23147_penmanshiel.php) |
...
|:new::exclamation:|21 | [Hill of Towie Wind Farm Open Dataset](https://zenodo.org/records/14870023)                                  | &cross;                                    | [SCT (on)](https://maps.app.goo.gl/e8H1enJBV1pAQqCi8) |&cross;        | 21        |**655**       | &check;                    | &cross;                            | 10m       | 8.7y        | -   | CC-BY-4.0; AeroUp/TuneUp upgrade info included, data loader [here](https://github.com/resgroup/hill-of-towie-open-source-analysis) |
