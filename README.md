...
|---|--|----------------------------------------------------------------------------------------------------------------|--------------------------------------------|-          |-              |-      |-      |-      |-                     |-          |-             | -  |--------------------------------------------|
|:star:|1 | [EDP Open Data](https://www.edp.com/en/innovation/open-data/data)                                              | [here](notebooks/edp_open_data.ipynb)      | ESP (on)  |&check;        | 5     |~80    | &check;     | &check;<sup>[1](#fn1)</sup>| 10m     | 2y |  - |  T09 removed from dataset |
...
|:new::exclamation:|21 | [Hill of Towie Wind Farm Open Dataset](https://zenodo.org/records/14870023)                                  | &cross;                                    | [SCT (on)](https://maps.app.goo.gl/e8H1enJBV1pAQqCi8) |&cross;        | 21        |56       | &check;                    | &cross;                            | 10m       | 8.7y        | -   | CC-BY-4.0; AeroUp/TuneUp upgrade info included, data loader [here](https://github.com/resgroup/hill-of-towie-open-source-analysis) |
